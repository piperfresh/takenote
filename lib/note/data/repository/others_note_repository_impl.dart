...
class OthersNoteRepositoryImpl extends StateNotifier<List<NoteEntity>> {
  OthersNoteRepositoryImpl() : super([]) {
  ...
  void _saveNotes() async {
    ...
    prefs.setStringList('otherNotes', notesJson);
  }

  // Load notes from shared preferences
  void _loadNotes() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    List<String>? notesJson = prefs.getStringList('otherNotes');
    if (notesJson != null) {
