...
class AcademicNoteRepositoryImpl extends StateNotifier<List<NoteEntity>> {
  AcademicNoteRepositoryImpl() : super([]) {
  ...
  void _saveNotes() async {
    ...
    prefs.setStringList('academicNotes', notesJson);
  }

  // Load notes from shared preferences
  void _loadNotes() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    List<String>? notesJson = prefs.getStringList('academicNotes');
    if (notesJson != null) {
